...
- The bounded local shuttle candidate/trajectory experiment is documented in `docs/shuttle-tracking.md`; it is packaged but intentionally unwired, with no TrackNet or uncleared model in the live path.
